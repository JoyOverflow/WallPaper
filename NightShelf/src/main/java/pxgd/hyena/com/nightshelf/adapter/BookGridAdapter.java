package pxgd.hyena.com.nightshelf.adapter;
...
import pxgd.hyena.com.nightshelf.R;
...
public class BookGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fragment_book_item, null);
            viewHolder.ivCover = convertView.findViewById(R.id.iv_cover);
            viewHolder.tvTitle = convertView.findViewById(R.id.tv_title);
            viewHolder.rbRate =  convertView.findViewById(R.id.rb_rate);
        ...
        Glide.with(viewHolder.ivCover.getContext())
                ...
                .placeholder(
                        new IconicsDrawable(
                                viewHolder.ivCover.getContext()
                        ).icon(GoogleMaterial.Icon.gmd_import_contacts).color(Color.GRAY).paddingDp(10))
